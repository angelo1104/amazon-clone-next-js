  ...
  return (
    <div className={styles.seller_main}>
        ...
        <div className={styles.seller_main_first_row}>
          ...
          <div className={styles.seller_main_first_right}>
            <Reveal effect={styles.fade_in} delay={1000}>
              <img
                className={styles.seller_main_first_img}
      ...
      <div className={styles.seller_main_second}>
        <Reveal effect={styles.fade_in_left} delay={500}>
          <div className={styles.seller_main_feature_card}>
            ...
            <h2 className={styles.feature_card_title}>Sell More</h2>

            <p className={styles.feature_card_desc}>
              Fresh new startups and Fortune 500s. B2B and B2C. Brand owners and
              resellers. Independent third-party sellers sold more than a
              billion items during the 2019 holiday season alone.
            </p>

            <a href="#" className={styles.seller_main_special_link}>
              How to get Started{" "}
            </a>
          </div>
        </Reveal>
        ...
        <Reveal effect={styles.fade_in_left} delay={900}>
          <div className={styles.seller_main_feature_card}>
            ...
            <h2 className={styles.feature_card_title}>Scale with FBA</h2>

            <p className={styles.feature_card_desc}>
              Leave the shipping, returns, and customer service to us with
              Fulfillment by Amazon (FBA). It’s the easiest way to reach 150
              million paid Prime members around the world.{" "}
            </p>
        ...
        <Reveal effect={styles.fade_in_left} delay={1300}>
          <div className={styles.seller_main_feature_card}>
            ...
            <h2 className={styles.feature_card_title}>Make money</h2>

            <p className={styles.feature_card_desc}>
              In 2019, nearly 225,000 Amazon sellers worldwide eclipsed $100,000
              in sales, up from nearly 200,000 in 2018—and 15,000 U.S.
              businesses broke $1 million.{" "}
            </p>

            <a href="#" className={styles.seller_main_special_link}>
              Explore selling programs
            </a>
          </div>
        </Reveal>
      </div>
      ...
      <div className={styles.seller_main_third}>
        <div className={styles.seller_main_third_row}>
          <Reveal effect={styles.fade_in_left} delay={500}>
            <div className={styles.third_left}>
              <img
                className={styles.third_main_image}
          ...
          <Reveal effect={styles.fade_in} delay={900}>
            <div className={styles.third_right}>
              ...
              <h3 className={styles.third_right_heading}>
                With all the infrastructure, systems, and processes Amazon built
                I realized that selling efficiency is no longer a problem.
              </h3>

              <div className={styles.name_author}>
                <img
                  className={styles.name_author_image}
                  src={
                    "https://m.media-amazon.com/images/G/01/sell/images/headshots/syang-2-2x.png"
                  }
                  alt=""
                />
        ...
        <div className={styles.seller_main_third_links}>
          ...
          <div className={styles.seller_main_links_third}>
            <a href="#" className={styles.seller_main_special_link}>
              Sell online with Amazon: Beginner's Guide
            </a>
            <a href="#" className={styles.seller_main_special_link}>
            ...
            <a href="#" className={styles.seller_main_special_link}>
              Watch free tutorial videos from Seller Academy
            </a>
            <a href="#" className={styles.seller_main_special_link}>
            ...
            <a href="#" className={styles.seller_main_special_link}>
              Case studies about Amazon third-party sellers
            </a>
          </div>
        </div>

        <p className={styles.seller_third_individual}>
          Just have a few items to sell?{" "}
          <a href="#" className={styles.seller_main_special_link_inline}>
      ...
      <div className={styles.seller_main_fourth}>
        <h1 className={styles.seller_fourth_heading}>Start selling today</h1>

        <h4 className={styles.seller_fourth_subheading}>
